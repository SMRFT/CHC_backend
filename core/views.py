    ...
    try:
        ...
        if from_date:
            try:
                ...
                employees = EmployeeRegistration.objects.filter(created_date__gte=start_of_day, created_date__lte=end_of_day)
                barcodes = list(employees.values_list('barcode', flat=True))
